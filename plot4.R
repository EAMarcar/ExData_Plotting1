...
## Open a grphics devive where the plot will be sent
...
plot(power$dt2, power$Voltage, type = "l", xlab= "datetime", ylab = "Voltage")

## Bottom left (this is also plot 3)
